    ...
    <section id="home" dir="rtl" className="relative w-full min-h-screen bg-[#2f488b] text-white overflow-hidden">
      ...
      <header className="mx-auto max-w-screen-2xl px-4 sm:px-6 lg:px-8 py-6">
        <div className="flex items-center justify-between gap-4">
          ...
          <a
            href="#partner"
            className="inline-flex items-center justify-center h-11 px-5 rounded-2xl bg-[#bedced] text-[#2f488b] font-semibold shadow-sm hover:brightness-105 active:scale-[0.99] transition"
          >
            سجل كا شريك
          </a>
        </div>
